...
Handicap.create(:user_id => 1,  :competition_id => 10,:handicap => 10.2, :date_adjusted => '2011-04-26')
Handicap.create(:user_id => 1,  :competition_id => 11,  :handicap => 9.8,  :date_adjusted => '2011-05-28')
Handicap.create(:user_id => 1,  :competition_id => 12,  :handicap => 8.9,  :date_adjusted => '2011-06-29')
Handicap.create(:user_id => 1,  :competition_id => 13,  :handicap => 9.0,  :date_adjusted => '2011-07-31')
Handicap.create(:user_id => 1,  :competition_id => 14,  :handicap => 9.1,  :date_adjusted => '2011-09-01')
Handicap.create(:user_id => 1,  :competition_id => 15,  :handicap => 9.0,  :date_adjusted => '2011-10-03')
Handicap.create(:user_id => 1,  :competition_id => 16,  :handicap => 8.7,  :date_adjusted => '2012-03-11')
Handicap.create(:user_id => 1,  :competition_id => 17,  :handicap => 7.8,  :date_adjusted => '2012-04-12')
Handicap.create(:user_id => 1,  :competition_id => 18,  :handicap => 7.8,  :date_adjusted => '2012-05-14')
Handicap.create(:user_id => 1,  :competition_id => 19,  :handicap => 7.9,  :date_adjusted => '2012-06-15')
Handicap.create(:user_id => 1,  :competition_id => 20,  :handicap => 8.0,  :date_adjusted => '2012-07-17')
Handicap.create(:user_id => 1,  :competition_id => 21,  :handicap => 8.1,  :date_adjusted => '2012-08-18')
Handicap.create(:user_id => 1,  :competition_id => 22,  :handicap => 8.2,  :date_adjusted => '2012-09-19')
Handicap.create(:user_id => 1,  :competition_id => 23,  :handicap => 8.3,  :date_adjusted => '2012-10-21')
Handicap.create(:user_id => 1,  :competition_id => 24,  :handicap => 8.4,  :date_adjusted => '2012-11-22')
Handicap.create(:user_id => 1,  :competition_id => 25,  :handicap => 8.5,  :date_adjusted => '2012-12-24')
Handicap.create(:user_id => 2,  :competition_id => 10,  :handicap => 15.0, :date_adjusted => '2011-04-26')
Handicap.create(:user_id => 2,  :competition_id => 11,  :handicap => 14.0, :date_adjusted => '2011-05-28')
Handicap.create(:user_id => 2,  :competition_id => 12,  :handicap => 14.1, :date_adjusted => '2011-06-29')
Handicap.create(:user_id => 2,  :competition_id => 13,  :handicap => 14.2, :date_adjusted => '2011-07-31')
Handicap.create(:user_id => 2,  :competition_id => 14,  :handicap => 13.8, :date_adjusted => '2011-09-01')
Handicap.create(:user_id => 2,  :competition_id => 15,  :handicap => 13.7, :date_adjusted => '2011-10-03')
Handicap.create(:user_id => 2,  :competition_id => 16,  :handicap => 12.9, :date_adjusted => '2012-03-11')
Handicap.create(:user_id => 2,  :competition_id => 17,  :handicap => 13.0, :date_adjusted => '2012-04-12')
Handicap.create(:user_id => 2,  :competition_id => 18,  :handicap => 13.1, :date_adjusted => '2012-05-14')
Handicap.create(:user_id => 2,  :competition_id => 19,  :handicap => 13.2, :date_adjusted => '2012-06-15')
Handicap.create(:user_id => 2,  :competition_id => 20,  :handicap => 12.9, :date_adjusted => '2012-07-17')
Handicap.create(:user_id => 2,  :competition_id => 21,  :handicap => 12.9, :date_adjusted => '2012-08-18')
Handicap.create(:user_id => 2,  :competition_id => 22,  :handicap => 12.5, :date_adjusted => '2012-09-19')
Handicap.create(:user_id => 2,  :competition_id => 23,  :handicap => 12.8, :date_adjusted => '2012-10-21')
Handicap.create(:user_id => 2,  :competition_id => 24,  :handicap => 12.6, :date_adjusted => '2012-11-22')
Handicap.create(:user_id => 2,  :competition_id => 25,  :handicap => 12.7, :date_adjusted => '2012-12-24')
Handicap.create(:user_id => 3,  :competition_id => 10,  :handicap => 24.6, :date_adjusted => '2011-04-26')
Handicap.create(:user_id => 3,  :competition_id => 11,  :handicap => 24.7, :date_adjusted => '2011-05-28')
Handicap.create(:user_id => 3,  :competition_id => 12,  :handicap => 24.8, :date_adjusted => '2011-06-29')
Handicap.create(:user_id => 3,  :competition_id => 13,  :handicap => 24.9, :date_adjusted => '2011-07-31')
Handicap.create(:user_id => 3,  :competition_id => 14,  :handicap => 24.8, :date_adjusted => '2011-09-01')
Handicap.create(:user_id => 3,  :competition_id => 15,  :handicap => 24.9, :date_adjusted => '2011-10-03')
Handicap.create(:user_id => 3,  :competition_id => 16,  :handicap => 25.0, :date_adjusted => '2012-03-11')
Handicap.create(:user_id => 3,  :competition_id => 17,  :handicap => 25.1, :date_adjusted => '2012-04-12')
Handicap.create(:user_id => 3,  :competition_id => 18,  :handicap => 24.4, :date_adjusted => '2012-05-14')
Handicap.create(:user_id => 3,  :competition_id => 19,  :handicap => 23.1, :date_adjusted => '2012-06-15')
Handicap.create(:user_id => 3,  :competition_id => 20,  :handicap => 23.2, :date_adjusted => '2012-07-17')
Handicap.create(:user_id => 3,  :competition_id => 21,  :handicap => 23.3, :date_adjusted => '2012-08-18')
Handicap.create(:user_id => 3,  :competition_id => 22,  :handicap => 23.4, :date_adjusted => '2012-09-19')
Handicap.create(:user_id => 3,  :competition_id => 23,  :handicap => 23.5, :date_adjusted => '2012-10-21')
Handicap.create(:user_id => 3,  :competition_id => 24,  :handicap => 23.5, :date_adjusted => '2012-11-22')
Handicap.create(:user_id => 3,  :competition_id => 25,  :handicap => 23.5, :date_adjusted => '2012-12-24')
Handicap.create(:user_id => 4,  :competition_id => 10,  :handicap => 16.2, :date_adjusted => '2011-04-26')
Handicap.create(:user_id => 4,  :competition_id => 11,  :handicap => 15.3, :date_adjusted => '2011-05-28')
Handicap.create(:user_id => 4,  :competition_id => 12,  :handicap => 15.4, :date_adjusted => '2011-06-29')
Handicap.create(:user_id => 4,  :competition_id => 13,  :handicap => 15.2, :date_adjusted => '2011-07-31')
Handicap.create(:user_id => 4,  :competition_id => 14,  :handicap => 15.0, :date_adjusted => '2011-09-01')
Handicap.create(:user_id => 4,  :competition_id => 15,  :handicap => 15.1, :date_adjusted => '2011-10-03')
Handicap.create(:user_id => 4,  :competition_id => 16,  :handicap => 15.2, :date_adjusted => '2012-03-11')
Handicap.create(:user_id => 4,  :competition_id => 17,  :handicap => 15.0, :date_adjusted => '2012-04-12')
Handicap.create(:user_id => 4,  :competition_id => 18,  :handicap => 15.0, :date_adjusted => '2012-05-14')
Handicap.create(:user_id => 4,  :competition_id => 19,  :handicap => 15.0, :date_adjusted => '2012-06-15')
Handicap.create(:user_id => 4,  :competition_id => 20,  :handicap => 14.8, :date_adjusted => '2012-07-17')
Handicap.create(:user_id => 4,  :competition_id => 21,  :handicap => 14.9, :date_adjusted => '2012-08-18')
Handicap.create(:user_id => 4,  :competition_id => 22,  :handicap => 15.0, :date_adjusted => '2012-09-19')
Handicap.create(:user_id => 4,  :competition_id => 23,  :handicap => 15.0, :date_adjusted => '2012-10-21')
Handicap.create(:user_id => 4,  :competition_id => 24,  :handicap => 15.1, :date_adjusted => '2012-11-22')
Handicap.create(:user_id => 4,  :competition_id => 25,  :handicap => 15.2, :date_adjusted => '2012-12-24')
Handicap.create(:user_id => 5,  :competition_id => 10,  :handicap => 6.0,  :date_adjusted => '2011-04-26')
Handicap.create(:user_id => 5,  :competition_id => 11,  :handicap => 6.1,  :date_adjusted => '2011-05-28')
Handicap.create(:user_id => 5,  :competition_id => 12,  :handicap => 5.9,  :date_adjusted => '2011-06-29')
Handicap.create(:user_id => 5,  :competition_id => 13,  :handicap => 5.8,  :date_adjusted => '2011-07-31')
Handicap.create(:user_id => 5,  :competition_id => 14,  :handicap => 5.7,  :date_adjusted => '2011-09-01')
Handicap.create(:user_id => 5,  :competition_id => 15,  :handicap => 5.5,  :date_adjusted => '2011-10-03')
Handicap.create(:user_id => 5,  :competition_id => 16,  :handicap => 5.5,  :date_adjusted => '2012-03-11')
Handicap.create(:user_id => 5,  :competition_id => 17,  :handicap => 5.5,  :date_adjusted => '2012-04-12')
Handicap.create(:user_id => 5,  :competition_id => 18,  :handicap => 5.2,  :date_adjusted => '2012-05-14')
Handicap.create(:user_id => 5,  :competition_id => 19,  :handicap => 5.3,  :date_adjusted => '2012-06-15')
Handicap.create(:user_id => 5,  :competition_id => 20,  :handicap => 5.3,  :date_adjusted => '2012-07-17')
Handicap.create(:user_id => 5,  :competition_id => 21,  :handicap => 5.1,  :date_adjusted => '2012-08-18')
Handicap.create(:user_id => 5,  :competition_id => 22,  :handicap => 5.1,  :date_adjusted => '2012-09-19')
Handicap.create(:user_id => 5,  :competition_id => 23,  :handicap => 5.1,  :date_adjusted => '2012-10-21')
Handicap.create(:user_id => 5,  :competition_id => 24,  :handicap => 5.2,  :date_adjusted => '2012-11-22')
Handicap.create(:user_id => 5,  :competition_id => 25,  :handicap => 4.9,  :date_adjusted => '2012-12-24')
Handicap.create(:user_id => 6,  :competition_id => 10,  :handicap => 4.9,  :date_adjusted => '2011-04-26')
Handicap.create(:user_id => 6,  :competition_id => 11,  :handicap => 4.8,  :date_adjusted => '2011-05-28')
Handicap.create(:user_id => 6,  :competition_id => 12,  :handicap => 4.6,  :date_adjusted => '2011-06-29')
Handicap.create(:user_id => 6,  :competition_id => 13,  :handicap => 4.2,  :date_adjusted => '2011-07-31')
Handicap.create(:user_id => 6,  :competition_id => 14,  :handicap => 4.3,  :date_adjusted => '2011-09-01')
Handicap.create(:user_id => 6,  :competition_id => 15,  :handicap => 3.5,  :date_adjusted => '2011-10-03')
Handicap.create(:user_id => 6,  :competition_id => 16,  :handicap => 3.5,  :date_adjusted => '2012-03-11')
Handicap.create(:user_id => 6,  :competition_id => 17,  :handicap => 3.2,  :date_adjusted => '2012-04-12')
Handicap.create(:user_id => 6,  :competition_id => 18,  :handicap => 3.1,  :date_adjusted => '2012-05-14')
Handicap.create(:user_id => 6,  :competition_id => 19,  :handicap => 3.0,  :date_adjusted => '2012-06-15')
Handicap.create(:user_id => 6,  :competition_id => 20,  :handicap => 2.5,  :date_adjusted => '2012-07-17')
Handicap.create(:user_id => 6,  :competition_id => 21,  :handicap => 2.0,  :date_adjusted => '2012-08-18')
Handicap.create(:user_id => 6,  :competition_id => 22,  :handicap => 2.1,  :date_adjusted => '2012-09-19')
Handicap.create(:user_id => 6,  :competition_id => 23,  :handicap => 1.5,  :date_adjusted => '2012-10-21')
Handicap.create(:user_id => 6,  :competition_id => 24,  :handicap => 1.1,  :date_adjusted => '2012-11-22')
Handicap.create(:user_id => 6,  :competition_id => 25,  :handicap => 1.0,  :date_adjusted => '2012-12-24')
Handicap.create(:user_id => 7,  :competition_id => 10,  :handicap => 0.5,  :date_adjusted => '2011-04-26')
Handicap.create(:user_id => 7,  :competition_id => 11,  :handicap => 0.6,  :date_adjusted => '2011-05-28')
Handicap.create(:user_id => 7,  :competition_id => 12,  :handicap => 0.7,  :date_adjusted => '2011-06-29')
Handicap.create(:user_id => 7,  :competition_id => 13,  :handicap => 0.8,  :date_adjusted => '2011-07-31')
Handicap.create(:user_id => 7,  :competition_id => 14,  :handicap => 0.9,  :date_adjusted => '2011-09-01')
Handicap.create(:user_id => 7,  :competition_id => 15,  :handicap => 1.0,  :date_adjusted => '2011-10-03')
Handicap.create(:user_id => 7,  :competition_id => 16,  :handicap => 1.1,  :date_adjusted => '2012-03-11')
Handicap.create(:user_id => 7,  :competition_id => 17,  :handicap => 1.2,  :date_adjusted => '2012-04-12')
Handicap.create(:user_id => 7,  :competition_id => 18,  :handicap => 1.2,  :date_adjusted => '2012-05-14')
Handicap.create(:user_id => 7,  :competition_id => 19,  :handicap => 1.1,  :date_adjusted => '2012-06-15')
Handicap.create(:user_id => 7,  :competition_id => 20,  :handicap => 1.0,  :date_adjusted => '2012-07-17')
Handicap.create(:user_id => 7,  :competition_id => 21,  :handicap => 1.1,  :date_adjusted => '2012-08-18')
Handicap.create(:user_id => 7,  :competition_id => 22,  :handicap => 0.8,  :date_adjusted => '2012-09-19')
Handicap.create(:user_id => 7,  :competition_id => 23,  :handicap => 0.5,  :date_adjusted => '2012-10-21')
Handicap.create(:user_id => 7,  :competition_id => 24,  :handicap => 0.1,  :date_adjusted => '2012-11-22')
Handicap.create(:user_id => 7,  :competition_id => 25,  :handicap => 0.2,  :date_adjusted => '2012-12-24')
...
# ===================================================================================================================
# COMPETITIONS SIGNUPS
# ===================================================================================================================

Signup.delete_all

Signup.create(:user_id => 7, :competition_id => 1)
Signup.create(:user_id => 2, :competition_id => 1)
Signup.create(:user_id => 5, :competition_id => 1)
Signup.create(:user_id => 1, :competition_id => 1)
Signup.create(:user_id => 4, :competition_id => 1)
Signup.create(:user_id => 6, :competition_id => 1)
Signup.create(:user_id => 3, :competition_id => 1)
Signup.create(:user_id => 3, :competition_id => 2)
Signup.create(:user_id => 1, :competition_id => 2)
Signup.create(:user_id => 1, :competition_id => 3)
Signup.create(:user_id => 1, :competition_id => 3)
Signup.create(:user_id => 4, :competition_id => 3)
Signup.create(:user_id => 7, :competition_id => 3)
Signup.create(:user_id => 2, :competition_id => 3)
Signup.create(:user_id => 5, :competition_id => 3)
